...
template<typename T,
        DistanceType dist_type,
        typename matrix_type>
int cpu_base_mt_probe<T, dist_type, matrix_type>::create_gallery(gallery<T, dist_type> ** ga_ptr){
...
template int cpu_base_mt_probe<int8_t, EUCLIDEAN, rapid_matrix_mul<int8_t> >::create_gallery(gallery<int8_t, EUCLIDEAN> ** ga_ptr);
template int cpu_base_mt_probe<float, EUCLIDEAN, rapid_matrix_mul<float> >::create_gallery(gallery<float, EUCLIDEAN> ** ga_ptr);
...
template<typename T,
        DistanceType dist_type,
        typename matrix_type>
int cpu_base_mt_probe<T, dist_type, matrix_type>::query(const T * const x, const int n, gallery<T, dist_type> * ga, Tout *sims, idx_t *idx){
...
template int cpu_base_mt_probe<int8_t, EUCLIDEAN, rapid_matrix_mul<int8_t>>::query(const int8_t * const x, const int n, gallery<int8_t, EUCLIDEAN> * ga, int *sims, idx_t *idx);
template int cpu_base_mt_probe<float, EUCLIDEAN, rapid_matrix_mul<float> >::query(const float * const x, const int n, gallery<float, EUCLIDEAN> * ga, float *sims, idx_t *idx);

template<typename T,
        DistanceType dist_type,
        typename matrix_type>
int cpu_base_mt_probe<T, dist_type, matrix_type>::query_with_uids(const T* const x, const int n, gallery<T, dist_type> * ga, idx_t *uids, const int m, Tout *sims, idx_t *idx){
...
template int cpu_base_mt_probe<int8_t, EUCLIDEAN, rapid_matrix_mul<int8_t>>::query_with_uids(const int8_t * const x, const int n, gallery<int8_t, EUCLIDEAN> * ga, idx_t *uids, const int m, int *sims, idx_t *idx);
template int cpu_base_mt_probe<float, EUCLIDEAN, rapid_matrix_mul<float> >::query_with_uids(const float * const x, const int n, gallery<float, EUCLIDEAN> * ga, idx_t *uids, const int m, float *sims, idx_t *idx);
}
